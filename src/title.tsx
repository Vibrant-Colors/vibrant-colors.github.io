  ...
  return (
    <div style={{position: "relative", maxWidth: "1200px", margin: "0 auto", width: "100%"}}>
      <svg
        ...
        <rect width="100%" height="100%" fill="#CF9D13" clipPath="url(#textClip)" />
        <text x="50%" y="80%" dominantBaseline="middle" textAnchor="middle" fontSize="9rem" fontWeight="800" fill="#2A3751">
          {title}
        </text>
        <text style={{userSelect: 'none'}} x="50%" y="80%" dominantBaseline="middle" textAnchor="middle" fontSize="9rem" fontWeight="800" fill="#ffff26" clipPath="url(#textClip)">
          {title}
        </text>
      </svg>
